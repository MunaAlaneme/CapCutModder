...
local ae_durations = {
    ['LumiCornerPin_46-effect0'] = {
        ['nodeDuration'] = {{0, 2}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 2}, },
        },
    },
    ['LumiCornerPin_25-effect0'] = {
        ['nodeDuration'] = {{0, 3}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 3}, },
        },
...
data.ae_attribute = {
    ['LumiCornerPin_46-effect0'] = {
        ['leftUpVertex'] = Amaz.Vector2f(0, .5),
        ['rightUpVertex'] = Amaz.Vector2f(1, 1),
        ['leftDownVertex'] = Amaz.Vector2f(0, 0),
        ['rightDownVertex'] = Amaz.Vector2f(1, 0),
        ['motionTileType'] = 0,
    },
    ['LumiCornerPin_25-effect0'] = {
        ['leftUpVertex'] = Amaz.Vector2f(0, 0),
        ['rightUpVertex'] = Amaz.Vector2f(0, 0),
        ['leftDownVertex'] = Amaz.Vector2f(0, 0),
        ['rightDownVertex'] = Amaz.Vector2f(0, 0),
        ['motionTileType'] = 0,
    },
    ['LumiLayer_46-blend'] = {
        ['hasBlend'] = true,
...
function LumiManager:onUpdate(comp, deltaTime)
    ...
    data.ae_attribute = {
        ['LumiCornerPin_46-effect0'] = {
            ['leftUpVertex'] = Amaz.Vector2f(value1, value2),
            ['rightUpVertex'] = Amaz.Vector2f(value3, value4),
            ['leftDownVertex'] = Amaz.Vector2f(value5, value6),
            ['rightDownVertex'] = Amaz.Vector2f(value7, value8),
            ['motionTileType'] = value9,
        },
        ['LumiCornerPin_25-effect0'] = {
            ['leftUpVertex'] = Amaz.Vector2f(0, 0),
            ['rightUpVertex'] = Amaz.Vector2f(0, 0),
    ...
    if data then
        ...
        if data.ae_fadeinInfos ~= nil then
            self.fadeinInfos = data.ae_fadeinInfos
        end
        if data.ae_fadeoutInfos ~= nil then
            self.fadeoutInfos = data.ae_fadeoutInfos
        end
...
function LumiManager:onEvent(comp, event)
    ...
    if event.args:get(0) == 'effects_adjust_speed9' then
        value9 = math.floor(event.args:get(1)+0.5)
    end
