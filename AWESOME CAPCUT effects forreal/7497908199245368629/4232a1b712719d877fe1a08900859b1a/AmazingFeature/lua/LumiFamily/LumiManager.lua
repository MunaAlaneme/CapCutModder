...
function LumiManager:onUpdate(comp, deltaTime)
    local ae_attribute = {
        ['LumiTone_30-effect0'] = {
            ['amount'] = 1,
            ['whiteColor'] = Amaz.Color(value1, value2, value3, value4),
            ['blackColor'] = Amaz.Color(value5, value6, value7, value8),
        },
        ['LumiLayer_30-blend'] = {
            ['hasBlend'] = true,
            ['hasMatte'] = false,
...
function LumiManager:onEvent(comp, event)
    ...
    if event.args:get(0) == 'start_time' and self.cameraMode then
