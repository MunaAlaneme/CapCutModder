...
data.ae_attribute = {
    ...
    ['LumiClone_78-effect0'] = {
        ...
        ['scale'] = value9,
        ['rotation'] = value2,
        ['center'] = Amaz.Vector2f(value7, value8),
        ['distribution'] = value10,
        ['initialScale'] = value11,
        ['startAlpha'] = value12,
        ['startZ'] = value13,
        ['endZ'] = value14,
        ['hueChange'] = value15,
...
function LumiManager:onEvent(comp, event)
    ...
    if event.args:get(0) == 'effects_adjust_speed2' then
        value2 = (event.args:get(1)*720.0)-360.0
    end
    if event.args:get(0) == 'effects_adjust_speed3' then
        value3 = math.floor(event.args:get(1)*2.0 + 0.5)
    end
    if event.args:get(0) == 'effects_adjust_speed4' then
        value4 = math.floor(event.args:get(1)+0.5)
    end
    if event.args:get(0) == 'effects_adjust_speed5' then
        value5 = event.args:get(1)*100.0
    end
    if event.args:get(0) == 'effects_adjust_speed6' then
        value6 = (event.args:get(1)*720.0)-360.0
    end
    if event.args:get(0) == 'effects_adjust_speed7' then
        value7 = (event.args:get(1)*2.0)-1.0
    end
    if event.args:get(0) == 'effects_adjust_speed8' then
        value8 = (event.args:get(1)*2.0)-1.0
    end
    if event.args:get(0) == 'effects_adjust_speed9' then
        value9 = (event.args:get(1)*2.0)-1.0
    end
    if event.args:get(0) == 'effects_adjust_speed10' then
        value10 = (event.args:get(1)*2.0)-1.0
    end
    if event.args:get(0) == 'effects_adjust_speed11' then
        value11 = (event.args:get(1)*2.0)-1.0
    end
    if event.args:get(0) == 'effects_adjust_speed12' then
        value12 = event.args:get(1)
    end
    if event.args:get(0) == 'effects_adjust_speed13' then
        value13 = (event.args:get(1)*2.0)-1.0
    end
    if event.args:get(0) == 'effects_adjust_speed14' then
        value14 = (event.args:get(1)*2.0)-1.0
    end
    if event.args:get(0) == 'effects_adjust_speed15' then
        value15 = (event.args:get(1)*2.0)-1.0
    end
    if event.args:get(0) == 'effects_adjust_speed16' then
        value16 = (event.args:get(1)*2.0)-1.0
    end
    if event.args:get(0) == 'effects_adjust_speed17' then
        value17 = event.args:get(1)
    end
